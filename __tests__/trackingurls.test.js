...
describe('When creating a tracking url', () => {
    ...
    test('With a script route and some parameters set - The url should contain the corresponding parameters', () => {
        ...
        expect(url).toBe('https://api.myunidays.com/tracking/v1.2/redemption/js?PartnerId=0LTio6iVNaKj861RM9azJQ%3D%3D&TransactionId=Order123&Currency=GBP&OrderTotal=209.00&Code=ABC123&ItemsTax=34.50&ShippingDiscount=3.00&ItemsGross=230.00&UNiDAYSDiscountPercentage=10.00');
    });
});