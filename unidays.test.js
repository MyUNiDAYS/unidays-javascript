...
describe('When calling generateQuery directly', () => {
    ...
    test('With all parameters set - The query should contain the corresponding parameters', () => {
        let query = tracking._generateQuery('0LTio6iVNaKj861RM9azJQ==', 'Order123', 'GBP', 209.00, 13.00, 'ABC123', 34.50, 5.00, 3.00, 230.00, 10.00, 10.00, 1);
    ...
    test('With some parameters set - The query should contain the corresponding parameters', () => {
        let query = tracking._generateQuery('0LTio6iVNaKj861RM9azJQ==', 'Order123', 'GBP', 209.00, null, 'ABC123', 34.50, null, 3.00, 230.00, null, 10.00, null);
