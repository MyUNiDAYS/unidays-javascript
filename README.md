...
<script type="text/javascript">
    (function (window) {
        ...
        var codedTrackingUrl = unidays.clientSideCodedUrl('Order123', 'GBP', 209.00, 13.00, 'ABC123', 34.50,
            5.00, 3.00, 230.00, 10.00, 10.00, 1);

        var codelessTrackingUrl = unidays.clientSideCodelessUrl('Order123', 'someMemberID', 'GBP', 209.00,
            13.00, 34.50, 5.00, 3.00, 230.00, 10.00, 10.00, 1);
